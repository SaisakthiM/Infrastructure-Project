      ...
      >
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="wa-label">Confirm Password</label>
              <input
                type="password"
            ...
            {(error || passwordError) && (
              <motion.div initial={{ opacity: 0, x: -6 }} animate={{ opacity: 1, x: 0 }} className="wa-error">
                {error || passwordError}
              </motion.div>
            )}
          ...
          <p className="text-center text-sm" style={{ color: "#8696A0" }}>
            ...
            <Link to="/login" className="wa-link font-semibold">
              Sign in
            </Link>
          </p>
        </motion.div>
